...
allergyCoachRouter.post("/gpt", async (req, res) => {
    try {
        ...
        pet, 
        // Current Episode
        startDate, affectedAreas, severity, visibleSigns, 
        // Environment
        currentSeason, recentChanges, livingEnvironment, 
        // Additional info
        currentMedications, knownAllergies, previousTreatments, } = req.body;
        console.log("pet:", pet);
